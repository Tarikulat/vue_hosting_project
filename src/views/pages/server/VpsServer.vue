        ...
        <div class="row justify-content-center head">
            <div class="col-md-12 col-lg-7">
                <div class="section-heading  text-center mb-5">
                    <h1 class="media-la">VPS Server Plan:</h1>
                    <p class="lead">
                            ...
                            <tr class="vps-pricing-row border-accent-primary">
                                ...
                                <td data-value="Geekbench Score">
                                    <div class="score-bar-wrap">
                                        ...
                                        <div class="progress w-100 score-bar-item">
                                            <div class="progress-bar primary-bg" role="progressbar" style="width: 30%;"
                                ...
                                <td>
                                    <a href="https://account.hostservice.com.bd/cart.php?a=confproduct&i=1"
                                        class="btn primary-solid-btn">Order Now</a>
                                </td>
                            </tr>
                            <tr class="vps-pricing-row border-red-themes">
                                ...
                                <td data-value="Geekbench Score">
                                    <div class="score-bar-wrap">
                                        ...
                                        <div class="progress w-100 score-bar-item">
                                            <div class="progress-bar primary-bg" role="progressbar" style="width: 40%;"
                                ...
                                <td data-value="Price">
                                    <p>
                                        ...
                                        <span class="pricing-onsale">On sale - <span class="badge color-1 color-1-bg">Save
                                                35%</span></span>
                                    </p>
                                </td>
                                <td>
                            ...
                            <tr class="vps-pricing-row border-orange-themes">
                                ...
                                <td data-value="Geekbench Score">
                                    <div class="score-bar-wrap">
                                        ...
                                        <div class="progress w-100 score-bar-item">
                                            <div class="progress-bar primary-bg" role="progressbar" style="width: 60%;"
                                ...
                                <td>
                                    <a href="https://account.hostservice.com.bd/index.php?rp=/store/vps-server/vps-gold"
                                        class="btn primary-solid-btn">Order Now</a>
                                </td>
                            </tr>
