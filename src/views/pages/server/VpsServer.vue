              ...
              <div class="col-lg-12 col-md-12 col-12">
                <div class="card text-center align-items-center single-pricing-pack">
                  ...
                  <div class="card-body">
                    ...
                    <a href="https://account.hostservice.com.bd/index.php?rp=/store/managed-vps-server/vps-standard" class="btn outline-btn mb-3"
              ...
              <div class="col-lg-12 col-md-12 col-12">
                <div class="card text-center align-items-center single-pricing-pack">
                  ...
                  <div class="card-body">
                    ...
                    <a href="https://account.hostservice.com.bd/index.php?rp=/store/business-hosting/vps-silver" class="btn outline-btn mb-3"
                      target="_blank">Purchase now</a>
                  </div>
                </div>
              </div>
                ...
                <thead class="comparision-table-head">
                  ...
                  <tr>
                    ...
                    <td class="primary-bg" style="width: 20%; text-align: center;">
                      <h5 class="text-white">VPS Starter </h5>
                    </td>
                    <td style="width: 20%; text-align: center;">
                      <h5>VPS Standard </h5>
                    </td>
  ...
  <section class="compare-provider-table gray-light-bg-n ro-bg">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
          <div class="section-heading  text-center mb-5">
            <h3 class="media-la text-brand">Vps Server Live Monitoring </h3>
            <p class="h5 web-s">
              ...
              <div id="accordion-one" class="accordion accordion-faq">
                ...
                <div class="card mb-0">
                  ...
                  <div id="collapseThree" class="collapse" data-parent="#accordion-one">
                    <div class="card-body">
                      <p>VPS hosting offers a higher level of security compared to shared hosting. Since each VPS operates
