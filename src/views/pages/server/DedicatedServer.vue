  ...
  <section class="pricing-section ptb-100">
    <div class="container">
      ...
      <div class="row align-items-center justify-content-between">
          ...
          <div class="card text-center align-items-center single-pricing-pack">
            ...
            <div class="card-body">
              <ul class="list-unstyled mb-4 pricing-feature-list">
                ...
                <li>1x3 Days Backup</li>
                <li>Shell access Non</li>
        ...
        <div class="col-lg-4 col-md-4 col-12">
          <div
            class="card popular-price align-items-center text-center single-pricing-pack"
          >
            <div class="pt-5">
              <h5 class="mb-0">
                Cloud Business <span class="badge color-1 color-1-bg">Popular</span>
              </h5>
            ...
            <div class="card-header pb-4 border-0 pricing-header">
              ...
              <div class="price text-center mb-0 yearly-price">
                $159<span>/yearly</span>
              </div>
              <div class="price text-center mb-0 biannual-price">
                $299<span>/biannual</span>
              </div>
              <div class="price text-center mb-0 triennial-price">
                $429<span>/triennial</span>
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled mb-4 pricing-feature-list">
              ...
              <a href="#" class="btn primary-solid-btn mb-3" target="_blank"
                >Purchase now</a
              >
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-4 col-12">
          <div class="card text-center align-items-center single-pricing-pack">
            ...
            <div class="card-header pb-4 border-0 pricing-header">
              ...
              <div class="price text-center mb-0 yearly-price">
                $259<span>/yearly</span>
              </div>
              <div class="price text-center mb-0 biannual-price">
                $499<span>/biannual</span>
              </div>
              <div class="price text-center mb-0 triennial-price">
                $739<span>/triennial</span>
              </div>
            </div>
            <div class="card-body">
              <ul class="list-unstyled mb-4 pricing-feature-list">
        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-lg-4 col-md-4 col-12">
            ...
            >
              <div class="pt-5">
                <h5 class="mb-0">
                  Cloud Blackbird <span class="badge color-1 color-1-bg">Popular</span>
                </h5>
          ...
          <div class="col-12">
            <div class="support-cta mt-5">
              <h5 class="mb-1 d-flex align-items-center justify-content-center">
                <span class="ti-loop color-primary mr-3 icon-sm"></span>Choose Your
                <a href="pricing-comparison.html" class="ml-2">Compare Hosting Plans</a>
              </h5>
            </div>
          </div>
        </div>
